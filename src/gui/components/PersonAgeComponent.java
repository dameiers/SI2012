...
*/
public class PersonAgeComponent extends javax.swing.JPanel implements ActionListener {
	private JLabel schoolLocationLbl;
	private PersonAgeComboBox ageCbo;
	private JButton removeBtn;
	private JPanel container;
	
	public PersonAgeComponent(JPanel container) {
		super();
		initGUI();
	...
	private void initGUI() {
		try {
			...
			this.setMaximumSize(new java.awt.Dimension(400, 63));
			{
				...
				schoolLocationLbl.setText("Person");
			}
			{

				ageCbo = new PersonAgeComboBox();
				this.add(ageCbo, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
